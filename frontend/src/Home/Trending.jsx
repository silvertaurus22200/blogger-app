        ...
        {blogs && blogs.length > 0 ? (
          blogs.slice(0, 6).map((element) => {
            return (
              <div
                key={element._id}
                className="p-4 bg-white border border-gray-400 rounded-lg shadow-md mx-2 mb-2"
              >
                <Link to={`/blog/${element?._id}`}>
                  ...
                  <div className="p-4 bg-gray-50 rounded-b-lg h-26 flex flex-col justify-between">
                    <h1
